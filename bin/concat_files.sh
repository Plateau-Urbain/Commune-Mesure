...
cat "Lieu;CategorieId;Categorie;QuestionId;Question;Type;Reponse" > "$EXPORT_DIR"/export_global_typeform.csv.tmp
...
cat "Lieu;CategorieId;QuestionId;Type;Reponse" > "$EXPORT_DIR"/export_global_genere.csv.tmp
