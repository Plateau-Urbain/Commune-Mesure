<div class="has-text-centered">
  ...
  @include('components.modals.modalEdition',['chemin'=>'blocs->accessibilite->donnees->transports', 'type' => 'checkbox','titre' => 'Modifier les moyens de transports accessibles'])
  </p>
</div>
