<section id="impact_social" class="is-flex is-flex-direction-column is-justify-content-center content-block">
  <div class="columns">
    <div class="column is-8 is-offset-2">
      ...
      <p class="mt-5">
        <a href="{{ route('impacts.show',['slug' => $place->getSlug() ]) }}" class="button mt-2">Voir ses effets sociaux</a>
        @isset($edit)
          <a href="{{ route('impacts.edit',['slug' => $place->getSlug(), 'auth' => $auth ]) }}" class="button mt-2">Éditer les effets sociaux</a>
        @endisset
      </p>
    </div>

  </div>
  <div class="column is-8 is-offset-2 container">
