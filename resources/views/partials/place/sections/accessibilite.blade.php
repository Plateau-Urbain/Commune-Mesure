<div class="has-text-centered">
  <p class="mb-5">
    ...
    @include('components.modals.modalEdition',['chemin'=>'blocs->accessibilite->donnees->accessibilite','id_section'=>'section02','type' => 'checkbox','titre' => "Modifier l'Accessibilité"])
  </p>
</div>
