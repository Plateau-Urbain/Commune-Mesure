...
@section('content')
    ...
    <div class="columns is-gapless" id="container">
      ...
      <!-- <form action="{{ route('place.update', ['slug' => $place->name, 'auth' => $auth]) }}" method="POST"> -->
          <!-- <p align="right" style="padding-right:10px;padding-top:20px"><input style="color:#e32d24"type="submit" value="Valider"></p> -->
        <div class="column">
                ...
                <section>
                  ...
                  <div class="section pt-5" style="padding-bottom:0;">
                    ...
                    <div class="column">
                      ...
                      <p align="right" style="padding:10px;font-size:30px"><a href="{{ route('place.update', ['slug' => $slug, 'auth' => $auth, 'json_field' => "description"]) }}">&#x1F441;</a></p>
                      <!-- Bloc note begin -->
                    ...
                    <div class="column">
                      <div id='acteurs' style="border:solid 1px black<?php if($place->partners->show == false):?>;opacity:0.5<?php endif;?>">
                        <p align="right" style="padding:10px;font-size:30px"><a href="{{ route('place.update', ['slug' => $slug, 'auth' => $auth, 'json_field' => "partners"]) }}">&#x1F441;</a></p>
                      <!-- Bloc note begin -->
                      <div class="bloc-note">
                          <div class="header-bloc-note">
                            <figure class="image">
              ...
              <div>
                  ...
                  <section class="section" id="valeurs">
                    ...
                    <div class="columns" style="border:solid 1px black<?php if(!$place->valeurs_show):?>;opacity:0.5<?php endif;?>">
                      ...
                      <p align="right" style="padding:10px;font-size:30px"><a href="{{ route('place.update', ['slug' => $slug, 'auth' => $auth, 'json_field' => "valeurs_show"]) }}">&#x1F441;</a></p>
                    </div>
                  </section>
                <section class="section" id="finances" >
                      <div class="columns">
                        <div class="column" id="moyens" style="border:solid 1px black<?php if(!$place->moyens_show):?>;opacity:0.5<?php endif;?>">
                          <p align="right" style="padding:10px;font-size:30px"><a href="{{ route('place.update', ['slug' => $slug, 'auth' => $auth, 'json_field' => "moyens_show"]) }}">&#x1F441;</a></p>
                        ...
                        <div class="column"id="composition" style="border:solid 1px black<?php if(!$place->composition_show):?>;opacity:0.5<?php endif;?>" >
                          <p align="right" style="padding:10px; font-size:30px"><a href="{{ route('place.update', ['slug' => $slug, 'auth' => $auth, 'json_field' => "composition_show"]) }}">&#x1F441;</a></p>
                  ...
                  <div class="columns" style="margin-top: 100px;">
                      <div class="column has-text-centered" style="position: relative;">
                          ...
                          <div class="impact_item" id="impact_item_reseaux" data-aos="fade-in" style="left: 110px;  bottom: -50px;border:solid 1px black<?php if(!$place->composition_show):?>;opacity:0.5<?php endif;?>">
                            <p align="right" style="font-size:20px"><a href="{{ route('place.update', ['slug' => $slug, 'auth' => $auth, 'json_field' => "reseau_show"]) }}">&#x1F441;</a></p>
                          ...
                          <div class="impact_item" id="impact_item_appartenance" data-aos="fade-right" style="right: 80px;  top: -45px;border:solid 1px black<?php if(!$place->composition_show):?>;opacity:0.5<?php endif;?>">
                            <p align="right" style="font-size:20px"><a href="{{ route('place.update', ['slug' => $slug, 'auth' => $auth, 'json_field' => "appartenance_show"]) }}">&#x1F441;</a></p>
                              @foreach($place->impact as $key => $impact)
                      ...
                      <div  class="column has-text-centered" style="position: relative;">
                          ...
                          <div class="impact_item" id="impact_item_sante" data-aos="fade-in" style="top: -45px; left: 85px;border:solid 1px black<?php if(!$place->sante_show):?>;opacity:0.5<?php endif;?>">
                            <p align="right" style="font-size:20px"><a href="{{ route('place.update', ['slug' => $slug, 'auth' => $auth, 'json_field' => "sante_show"]) }}">&#x1F441;</a></p>
                              @foreach($place->impact as $key => $impact)
                          ...
                          <div class="impact_item" id="impact_item_insertion" data-aos="fade-in" style="bottom: -40px; left: 50px;border:solid 1px black<?php if(!$place->insertion_show):?>;opacity:0.5<?php endif;?>">
                            <p align="right" style="font-size:20px"><a href="{{ route('place.update', ['slug' => $slug, 'auth' => $auth, 'json_field' => "insertion_show"]) }}">&#x1F441;</a></p>
                              @foreach($place->impact as $key => $impact)
                          ...
                          <div class="impact_item" id="impact_item_lien" data-aos="fade-in" style="top: -45px; right: 130px;border:solid 1px black<?php if(!$place->lien_sociaux_show):?>;opacity:0.5<?php endif;?>">
                            <p align="right" style="font-size:20px"><a href="{{ route('place.update', ['slug' => $slug, 'auth' => $auth, 'json_field' => "lien_sociaux_show"]) }}">&#x1F441;</a></p>
                              @foreach($place->impact as $key => $impact)
                          ...
                          <div class="impact_item" id="impact_item_capacite" data-aos="fade-in" style="bottom: -40px;right: 80px;border:solid 1px black<?php if(!$place->capacite_show):?>;opacity:0.5<?php endif;?>">
                            <p align="right" style="font-size:20px"><a href="{{ route('place.update', ['slug' => $slug, 'auth' => $auth, 'json_field' => "capacite_show"]) }}">&#x1F441;</a></p>
            ...
            <section class="section anchor" id="territoire">
              ...
              <div class="section" style="border:solid 1px black<?php if(!$place->lieu_territoire_show):?>;opacity:0.5<?php endif;?>">
                <p align="right" style="font-size:30px"><a href="{{ route('place.update', ['slug' => $slug, 'auth' => $auth, 'json_field' => "lieu_territoire_show"]) }}">&#x1F441;</a></p>
                <div class="columns">
                  <div class="column">
