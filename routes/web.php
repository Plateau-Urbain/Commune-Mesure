...
$router->get('/impacts/{slug}/{auth:[a-z0-9]+}/edit', ['uses' => 'ImpactSocialController@edit', 'as' => 'impacts.edit']);
...
$router->get('/api/search/places', ['uses' => 'Api\Search@place', 'as' => 'api.search.places']);
